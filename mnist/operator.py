...
os.system("python3.6 batch_eth_mnist.py --connectivity 0.5")
os.system("python3.6 batch_eth_mnist.py --connectivity 0.55")
os.system("python3.6 batch_eth_mnist.py --connectivity 0.60")
os.system("python3.6 batch_eth_mnist.py --connectivity 0.65")
